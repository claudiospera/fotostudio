...
export const PRODUCTS: Product[] = [
...

  {
    ...
    variants: [
      { id: 'sc-10x15', label: '10×15 cm', price: 200, priceBreaks: breaks10x15, widthCm: 10, heightCm: 15 },
      { id: 'sc-13x18', label: '13×18 cm', price: 250, priceBreaks: breaks13x18, widthCm: 13, heightCm: 18 },
      { id: 'sc-13x19', label: '13×19 cm', price: 250, priceBreaks: breaks13x18, widthCm: 13, heightCm: 19 },
      { id: 'sc-15x15', label: '15×15 cm', price: 250, priceBreaks: breaks13x18, widthCm: 15, heightCm: 15 },
      { id: 'sc-15x20', label: '15×20 cm', price: 300, priceBreaks: breaks15x20, widthCm: 15, heightCm: 20 },
      { id: 'sc-15x23', label: '15×23 cm', price: 300, priceBreaks: breaks15x20, widthCm: 15, heightCm: 23 },
      { id: 'sc-13x9',  label: '13×9 cm',  price: 200, priceBreaks: breaks13x9,  widthCm: 13, heightCm:  9 },
    ],
    featured: true,
...

  {
    ...
    options: {
      frames: [
        { id: 'holographic',   label: 'Olografico',  color: 'linear-gradient(135deg, #ff9af5 0%, #ffe04b 20%, #4bf5ff 40%, #b44bff 60%, #4bffe0 80%, #ff9af5 100%)',                                                                        border: 'transparent' },
        { id: 'teal',          label: 'Turchese',    color: '#5bc8c8',                                                                                                                                                                       border: 'transparent' },
        { id: 'black',         label: 'Nero',        color: '#111111',                                                                                                                                                                       border: 'rgba(255,255,255,.2)' },
        { id: 'polka',         label: 'Pallini',     color: 'radial-gradient(circle, #e74c3c 2px, transparent 2px) 0 0 / 12px 12px, radial-gradient(circle, #3498db 2px, transparent 2px) 6px 6px / 12px 12px, radial-gradient(circle, #2ecc71 2px, transparent 2px) 3px 9px / 12px 12px, radial-gradient(circle, #f39c12 2px, transparent 2px) 9px 3px / 12px 12px', border: 'rgba(0,0,0,.15)' },
        { id: 'popart',        label: 'WOW!',        color: 'linear-gradient(135deg, #00b4c8 0%, #00d4a8 33%, #ff6b35 66%, #ffcc00 100%)',                                                                                                   border: 'transparent' },
        { id: 'rose-glitter',  label: 'Rose Gold',   color: 'repeating-linear-gradient(45deg, #f4a2a0 0px, #e88580 1px, #fac0b8 3px, #e89088 5px, #fad0c0 7px, #e89898 9px)',                                                             border: 'transparent' },
        { id: 'silver',        label: 'Silver',      color: 'repeating-linear-gradient(45deg, #b0c4d8 0px, #d0e0ec 1px, #a8b8cc 3px, #c8d8e8 5px, #b8ccd8 7px, #d4e4f0 9px)',                                                            border: 'transparent' },
        { id: 'gradient',      label: 'Gradiente',   color: 'linear-gradient(135deg, #ff69b4 0%, #ff4500 33%, #4169e1 66%, #40e0d0 100%)',                                                                                                  border: 'transparent' },
        { id: 'marble',        label: 'Marmo',       color: 'linear-gradient(135deg, #1a3a4c 0%, #2c5468 25%, #1a2e3a 50%, #234558 75%, #2a4a5c 100%)',                                                                                     border: 'transparent' },
        { id: 'gray',          label: 'Grigio',      color: '#9e9e9e',                                                                                                                                                                      border: 'transparent' },
        { id: 'pink',          label: 'Rosa',        color: '#ff91a4',                                                                                                                                                                      border: 'transparent' },
        { id: 'rainbow',       label: 'Arcobaleno',  color: 'linear-gradient(135deg, #ff9aa2 0%, #ffdac1 25%, #e2f0cb 50%, #b5ead7 75%, #c7ceea 100%)',                                                                                    border: 'transparent' },
        { id: 'white',         label: 'Bianco',      color: '#f8f8f8',                                                                                                                                                                      border: 'rgba(0,0,0,.15)' },
        { id: 'nessuna',       label: 'Nessuna',     color: 'transparent',                                                                                                                                                                  border: 'rgba(0,0,0,.15)' },
      ],
    },
    featured: false,
    createdAt: '2026-01-01T00:00:00Z',
...

  {
    ...
    // prezzi base = Matte FineArt 200 (carta più economica); il tipo carta si sceglie nelle opzioni
    variants: [
      { id: 'hah-10x15',  label: '10×15 cm',  price:  400, widthCm: 10, heightCm: 15 },
      { id: 'hah-15x15',  label: '15×15 cm',  price:  500, widthCm: 15, heightCm: 15 },
      { id: 'hah-13x18',  label: '13×18 cm',  price:  600, widthCm: 13, heightCm: 18 },
      { id: 'hah-15x20',  label: '15×20 cm',  price:  700, widthCm: 15, heightCm: 20 },
      { id: 'hah-15x22',  label: '15×22 cm',  price:  800, widthCm: 15, heightCm: 22 },
      { id: 'hah-16x24',  label: '16×24 cm',  price:  900, widthCm: 16, heightCm: 24 },
      { id: 'hah-20x20',  label: '20×20 cm',  price: 1000, widthCm: 20, heightCm: 20 },
      { id: 'hah-18x24',  label: '18×24 cm',  price: 1000, widthCm: 18, heightCm: 24 },
      { id: 'hah-20x25',  label: '20×25 cm',  price: 1100, widthCm: 20, heightCm: 25 },
      { id: 'hah-20x30',  label: '20×30 cm',  price: 1200, widthCm: 20, heightCm: 30 },
      { id: 'hah-24x30',  label: '24×30 cm',  price: 1300, widthCm: 24, heightCm: 30 },
      { id: 'hah-24x36',  label: '24×36 cm',  price: 1500, widthCm: 24, heightCm: 36 },
      { id: 'hah-30x30',  label: '30×30 cm',  price: 1500, widthCm: 30, heightCm: 30 },
      { id: 'hah-30x40',  label: '30×40 cm',  price: 1800, widthCm: 30, heightCm: 40 },
      { id: 'hah-30x45',  label: '30×45 cm',  price: 2000, widthCm: 30, heightCm: 45 },
      { id: 'hah-35x50',  label: '35×50 cm',  price: 2500, widthCm: 35, heightCm: 50 },
      { id: 'hah-30x60',  label: '30×60 cm',  price: 2600, widthCm: 30, heightCm: 60 },
      { id: 'hah-40x50',  label: '40×50 cm',  price: 2700, widthCm: 40, heightCm: 50 },
      { id: 'hah-40x60',  label: '40×60 cm',  price: 2900, widthCm: 40, heightCm: 60 },
      { id: 'hah-50x50',  label: '50×50 cm',  price: 3200, widthCm: 50, heightCm: 50 },
      { id: 'hah-50x60',  label: '50×60 cm',  price: 3400, widthCm: 50, heightCm: 60 },
      { id: 'hah-50x70',  label: '50×70 cm',  price: 3800, widthCm: 50, heightCm: 70 },
      { id: 'hah-60x60',  label: '60×60 cm',  price: 4200, widthCm: 60, heightCm: 60 },
      { id: 'hah-60x80',  label: '60×80 cm',  price: 5000, widthCm: 60, heightCm: 80 },
      { id: 'hah-60x90',  label: '60×90 cm',  price: 5500, widthCm: 60, heightCm: 90 },
    ],
    options: {
      printTypes: [
        { id: 'mf200',  label: 'Matte FineArt 200',          description: '100% cotone, opaca naturale, ottimo rapporto qualità/prezzo',      extraPrice: 0 },
        { id: 'pr308',  label: 'Photo Rag 308',               description: '100% cotone 308g, vellutata, bianco naturale caldo — per ritratti', extraPrice: 0 },
        { id: 'pmb308', label: 'Photo Rag Matt Baryta 308',   description: '100% cotone, semi-lucida tipo FB, neri profondi — per B&N',        extraPrice: 0 },
        { id: 'me350',  label: 'Museum Etching 350',          description: '100% cotone 350g, texture acquarello — per stampe d\'arte',        extraPrice: 0 },
        { id: 'to285',  label: 'Torchon 285 (max 30×40 cm)', description: '100% α-cellulosa, ruvido tipo acquarello, bianco brillante',        extraPrice: 0 },
      ],
    },
    featured: true,
    createdAt: '2026-01-01T00:00:00Z',
...

  {
    ...
    variants: [
      { id: 'pos-20x30', label: '20×30 cm', price:  600, widthCm: 20, heightCm: 30 },
      { id: 'pos-24x30', label: '24×30 cm', price:  700, widthCm: 24, heightCm: 30 },
      { id: 'pos-30x30', label: '30×30 cm', price:  800, widthCm: 30, heightCm: 30 },
      { id: 'pos-30x40', label: '30×40 cm', price: 1000, widthCm: 30, heightCm: 40 },
      { id: 'pos-30x45', label: '30×45 cm', price: 1200, widthCm: 30, heightCm: 45 },
      { id: 'pos-30x60', label: '30×60 cm', price: 1700, widthCm: 30, heightCm: 60 },
      { id: 'pos-36x42', label: '36×42 cm', price: 1200, widthCm: 36, heightCm: 42 },
      { id: 'pos-40x40', label: '40×40 cm', price: 1600, widthCm: 40, heightCm: 40 },
      { id: 'pos-35x50', label: '35×50 cm', price: 1600, widthCm: 35, heightCm: 50 },
      { id: 'pos-40x50', label: '40×50 cm', price: 1700, widthCm: 40, heightCm: 50 },
      { id: 'pos-40x60', label: '40×60 cm', price: 1900, widthCm: 40, heightCm: 60 },
      { id: 'pos-50x50', label: '50×50 cm', price: 2000, widthCm: 50, heightCm: 50 },
      { id: 'pos-50x60', label: '50×60 cm', price: 2300, widthCm: 50, heightCm: 60 },
      { id: 'pos-50x70', label: '50×70 cm', price: 2500, widthCm: 50, heightCm: 70 },
    ],
    featured: false,
    createdAt: '2026-01-01T00:00:00Z',
  },
...

  {
    ...
    options: {
      printTypes: [
        { id: 'lucida', label: 'Tela Lucida',       description: 'Colori vividi, effetto brillante',   extraPrice: 0 },
        { id: 'opaca',  label: 'Tela Opaca (Mat)',   description: 'Effetto pittorico, anti-riflesso',   extraPrice: 0 },
      ],
    },
  },
...

  {
    ...
    variants: [
      { id: '10x15', label: '10×15 cm', price: 1000, widthCm: 10, heightCm: 15 },
      { id: '13x18', label: '13×18 cm', price: 1250, widthCm: 13, heightCm: 18 },
      { id: '15x20', label: '15×20 cm', price: 1500, widthCm: 15, heightCm: 20 },
      { id: '20x30', label: '20×30 cm', price: 2000, widthCm: 20, heightCm: 30 },
      { id: '30x40', label: '30×40 cm', price: 3000, widthCm: 30, heightCm: 40 },
      { id: '30x60', label: '30×60 cm', price: 4100, widthCm: 30, heightCm: 60 },
      { id: '40x50', label: '40×50 cm', price: 4200, widthCm: 40, heightCm: 50 },
      { id: '40x60', label: '40×60 cm', price: 4700, widthCm: 40, heightCm: 60 },
      { id: '50x60', label: '50×60 cm', price: 5300, widthCm: 50, heightCm: 60 },
      { id: '50x70', label: '50×70 cm', price: 5700, widthCm: 50, heightCm: 70 },
    ],
    featured: true,
    createdAt: '2026-01-01T00:00:00Z',
    options: {
...

  {
    ...
    variants: [
      { id: 'sal-std', label: 'Standard', price: 1500, widthCm: 20, heightCm: 8.5 },
    ],
    featured: false,
    createdAt: '2026-01-01T00:00:00Z',
  },

  {
    ...
    variants: [
      { id: 'bor-inox-600', label: '600ml', price: 1500, widthCm: 22, heightCm: 14 },
    ],
    featured: false,
    createdAt: '2026-01-01T00:00:00Z',
  },

  {
    ...
    variants: [
      { id: 'bor-alu-std', label: 'Standard', price: 1500, widthCm: 22, heightCm: 11 },
    ],
    featured: false,
    createdAt: '2026-01-01T00:00:00Z',
  },
