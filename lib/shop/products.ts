...
export const PRODUCTS: Product[] = [
...

  {
    ...
    variants: [
      { id: 'pol-mini',   label: 'Instax Mini (54×86 mm)',   price: 200, priceBreaks: breaksInstax, widthCm: 5.4, heightCm: 8.6 },
      { id: 'pol-square', label: 'Instax Square (62×62 mm)', price: 200, priceBreaks: breaksInstax, widthCm: 6.2, heightCm: 6.2 },
      { id: 'pol-wide',   label: 'Instax Wide (99×62 mm)',   price: 200, priceBreaks: breaksInstax, widthCm: 9.9, heightCm: 6.2 },
    ],
    options: {
      frames: [
